...
class AgendaContactos:
    """
    Clase que gestiona una coleción de contactos.
    
    Attributes:
        contactos (lista): Lista de objetos Contacto.
    ...
    def __init__(self, ruta_archivo="contactos.json"):
        ...
        Args:
            ruta_archivo (str, opcional): ): Ruta al archivo para guardar los contactos.
            
        """
        self.contactos = []
        self.ruta_archivo = ruta_archivo
        #Intntar cargar contactos existentes si el archivo existe.
        self.cargar()
    ...
    def buscar(self, termino):
        """
        Busca contatos que conincidan con el término de busqueda.

        Args:
            termino (str): Término a buscar en nombre, telefono, email.
        Returns:
            list: Lista de contactos que coincide con la búsqueda.
        """
        resultados = []
        termino = termino.lower()
        
        for contacto in self.contactos:
            if (termino in contacto.nombre.lower() or termino in contacto.telefono.lower() or termino in contacto.email.lower()):
    ...
    def eliminar(self, nombre):
        """
        Elimina un caontacto de la agenda.
    ...
    def listar(self):
        """
        Devuelve la lista de completa de contactos.
        Returns:
    ...
    def guardar(self):
        ...
        """
        try:
            # Convertir objetos Contato a diccionarios
            datos = []
            for contacto in self.contactos:
                datos.append({
    ...
    def cargar(self):
        ...
        try:
            ...
            #Convertir diccionarios a objeto Contato
            self.contactos =[]
            for dato in datos:
                contacto = Contacto(
                    dato["nombre"], 
